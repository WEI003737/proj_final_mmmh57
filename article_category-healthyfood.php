...
$page_name = "article_category-healthyfood";
...
<head>
    ...
    <title>article_category-healthyfood</title>
...
<!--        integrity="sha384-oS3vJWv+0UjzBfQzYUhtDYW+Pj2yciDJxpsK1OYPAYjqT085Qq/1cq5FLXAZQ7Ay" crossorigin="anonymous">-->
    ...
    <?php include __DIR__. '/css/article_category-healthyfood.php';?>
                    ...
                    <div class="cin_articleCategory_main_L">
                        ...
                        <div class="cin_article_card"><a href="">
                                <div class="cin_article_card_img">
                                    <img src="./img/articleCategory-healthy1.png" alt="">
                                </div>
                        ...
                        <div class="cin_article_card"><a href="article_innerText_2.php">
                                <div class="cin_article_card_img">
                                    <img src="./img/articleCategory-healthy2.png" alt="">
                                </div>
                                <div class="cin_article_card_titleDash">
                                    <h5>健康食物</h5>
                                </div>
                                <div class="cin_article_card_parag">
                                    <h5>女性健身者專用 快速Meal Prep健康飲食法
                                    </h5>
                                </div>
                                <div class="cin_article_card_date d-flex space-between">
                                    <h5>2020/04/28</h5>
                        ...
                        <div class="cin_article_card"><a href="">
                                <div class="cin_article_card_img">
                                    <img src="./img/articleCategory-healthy4.png" alt="">
                                </div>
                                <div class="cin_article_card_titleDash">
                                    <h5>健康食物</h5>
                                </div>
                        ...
                        <div class="cin_article_card"><a href="">
                                <div class="cin_article_card_img">
                                    <img src="./img/articleCategory-healthy3.png" alt="">
                                </div>
                                <div class="cin_article_card_titleDash">
                                    <h5>健康食物</h5>
                                </div>
                                <div class="cin_article_card_parag">
                                    <h5>不發胖的爆漿甜點！無油熔岩巧克力</h5>
                                </div>
                                <div class="cin_article_card_date d-flex space-between">
                                    <h5>2020/04/19</h5>
                                    <h5>By Web only</h5>
