...
<body>
    ...
    <div class="container qa_main_outbox">
        ...
        <div class="qa_main">
                ...
                <ul>
                    <li class="qa_open_btn">
                        ...
                        <p class="nac">
                            ...
                            4. 會員可獲得網站最新訊息，参與各項網站活動、專屬優惠與會員福利等服務。
                        </p>
                    </li>
                    <li class="qa_open_btn">
                        <h4 class="nac">信用卡線上刷卡</h6>
                            <p class="nac">
                                ...
                                </br>※待您完成付款，REDCORE會於1~3個工作天內為您安排出貨，您將於2~5個工作天收到商品(不含假日)。
                            </p>
                    </li>
                </ul>
            </div>
                ...
                <ul>
                    ...
                    <li class="qa_open_btn">
                        <h4 class="nac">其他費用</h6>
                            <p class="nac">
                                1. 如因收件地址、電話資訊有誤或連絡不到收件人等無法投遞之情況，我們會先嘗試聯絡訂購人確認收件資料，其中所產生的物流空跑費，或相關改址增加費用，則需另行向您收取。若仍無法順利聯繫，導致商品必須遣返退回，當中所產生之倉儲、稅金、運輸等因配送所需費用，我們將於收到退回商品後，由付款金額中扣除並進行退刷，敬請留意。
                            </p>
                    </li>
                </ul>
            </div>
            ...
            <div class="qa_main_box">
                <h3 class="nac">常見問題 / 退換貨政策</h3>
                <ul>
                    <li class="qa_open_btn">
                        <h4 class="nac">七天鑑賞期</h4>
                        <p class="nac">
                            1. 特價出清商品一律不接受退換貨服務，如商品本身為瑕疵，可接受7日內退換貨。</br>
                            2. 提供商品7天鑑賞期(含例假日)，若商品未經拆封、使用或被汙損，皆可申請退換貨。</br>
                ...
                <ul>
                    <li class="qa_open_btn">
                        ...
                        <p class="nac">
                            ...
                            Step2．確認身份：如已是會員請輸入帳號及密碼。非會員請先註冊成為會員(您也可以不須註冊直接下單)。
                            </br>
                    ...
                    <li class="qa_open_btn">
                        <h4 class="nac">瀏覽訂單記錄及狀況</h6>
                            ...
                            <p class="nac">
                                ...
                                如有其他問題，歡迎來信至客服info@redcore.com.tw聯繫，我們將特別為您確認。</p>
    ...
    <script>
        $(".qa_open_btn").click(
            function() {
                $(this).toggleClass("nac_qa_info_open").find("p.nac").slideToggle()
                $(this).siblings().removeClass("nac_qa_info_open").find("p.nac").slideUp()
            }
        )
