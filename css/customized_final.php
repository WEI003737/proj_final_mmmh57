<style>
    ...
    .nac_customized_menu.nac_customized_menu_normal ul li a {
        ...
        transition: .5s;
        border: 1px solid rgb(202, 5, 77,0);

    }

    .nac_customized_menu.nac_customized_menu_normal ul li:nth-child(0):after,
    .nac_customized_menu.nac_customized_menu_normal ul li:nth-child(1):after,
    .nac_customized_menu.nac_customized_menu_normal ul li:nth-child(3):after,
    .nac_customized_menu.nac_customized_menu_normal ul li:nth-child(2):after {
        content: "/";
        padding: 0px 10px;
    }

    .nac_customized_menu.nac_customized_menu_normal ul li a:hover,
    .nac_customized_menu.nac_customized_menu_normal ul li a.active {
        background: #fff;
        color: rgb(202, 5, 77);
        cursor: pointer;
        box-shadow: rgb(202, 5, 77, .3) 0px 3px 5px;
        transform: translateY(-5px);
        border: 1px solid rgb(202, 5, 77,.2);
    }
    ...
    input.nac_size_btn.active,
    input.nac_size_btn:hover {
        background: rgb(202, 5, 77);
        border: 1px solid rgb(202, 5, 77);
        color: #FFF;
    }
    ...
    .nac_customized_title_box.nac_customized_flotup_cansee,
    .nac_customized_menu ul li.nac_customized_flotup_cansee,
    .nac_customized_item_area.nac_customized_flotup_cansee,
    .nac_customized_help.nac_customized_flotup_cansee {
        animation: nac_customized_flotup_cansee;
        animation-duration: .8s;
        /* animation-fill-mode: forwards; */
    }

    .nac_customized_title_box.nac_animation_is_run,
    .nac_customized_menu ul li.nac_animation_is_run,
    .nac_customized_item_area.nac_animation_is_run,
    .nac_customized_help.nac_animation_is_run {
        opacity: 1;
    }
